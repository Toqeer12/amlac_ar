...
<body class="fixed-top">
   <!-- BEGIN HEADER -->
  <?php /*?> <div id="header" class="navbar navbar-inverse navbar-fixed-top">
...
<form name="frmUser" method="post" action="">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="widget">
                            ...
                            <span class="tools">
                               <button type="button" class="btn btn-primary" onClick="window.location.href='add_pay_grade.php'">Add</button>
                               <input type="button" name="delete" value="Delete"  class="icon-remove icon-white" onClick="setDeleteAction();" />
                        ...
                        <div class="widget-body">
                            ...
                            <thead>
                                    ...
                                    <th class="hidden-phone">Min Salary</th>
                                     <th class="hidden-phone">Max Salary</th>
		...
		$sql = "SELECT * FROM `Pay_Grade` Where c_id='$var'";
