...
<body id="login-body">
  ...
  <div id="login">
    <!-- BEGIN LOGIN FORM -->
    <form id="form" class="form-vertical" method="POST">
      <div class="lock">
      </div>
          ...
          <div class="control-group">
		    ...
		    <div class="control-group">
              <div class="controls">
                  <div class="input-prepend">
                      <span class="add-on"><i class="icon-user"></i></span> 
					  <input name="comp_name"id="comp_name" pattern="[a-zA-z\s]+" type="text"  value="<?php echo $_SESSION['company'];?>"readonly/>
                  </div>
              </div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
              <div class="controls">
                  <div class="input-prepend">
                      ...
                      <input name="type"id="type"   type="hidden"  value="owner" required/>
                        <input name="real_id"id="real_id"   type="hidden"  value="<?php echo $_SESSION['Id']?>" required/>
                  </div>
              </div>
			</div>
      </div>

      <input type="submit" id="login-btn" class="btn btn-block login-btn" onclick="signup(this)"/>
 ...
 <script type="text/javascript">
  ...
  function signup(obj)
  {
      debugger;
        ...
        var type=$('#type').val();
        var com=$('#real_id').val();
        var dataString= 'fullname='+ fullname + '&email='+ email+ '&compname='+ compname  + '&mobile='+ mobile  + '&pin='+ pin + '&address='+ address + '&city='+ city+'&type='+type+'&com='+com; 
	 $.ajax({
